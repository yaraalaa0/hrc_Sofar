...
//initializing the move groups interfaces for both right and left baxter arms
void setup(){
...
bool callback_pickplace(human_baxter_servers::PickPlace::Request &req, human_baxter_servers::PickPlace::Response &res){
  ...
  if(hand == "right"){
    ...
    move_group_interface_r->setPoseTarget(target_pose2);
    ...
    move_group_interface_r->setPoseTarget(target_pose3);
    ...
    move_group_interface_l->setPoseTarget(target_pose2);
    ...
    move_group_interface_l->setPoseTarget(target_pose3);
